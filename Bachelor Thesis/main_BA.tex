...
\usepackage[style=authoryear]{biblatex} % for the citation, change style if you want
...
\newcommand{\Title}{A Minimal Working Example for a Bachelor Thesis} 
...
\newcommand{\Date}{31-12-2019}
\newcommand{\Semester}{Fall Term 2019}
\newcommand{\Supervisor}{Supervisor}
\newcommand{\Pruefer}{Prof. Dr. Marcel Tyrell}
